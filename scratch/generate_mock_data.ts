...
async function generateMockData() {
	...
	if (!users.length || !customer) {
		console.error(
			"❌ HATA: Kullanıcı veya müşteri bulunamadı. Lütfen önce seed scriptini çalıştırın.",
		);
		return;
	}
	...
	const projects = [
		{
			title: "Modern Ofis Masaları Kurulumu",
			desc: "15 adet workstation montajı ve kablolama.",
		},
		{
			title: "Klinik Karşılama Bankosu",
			desc: "Özel tasarım ahşap banko montajı ve LED aydınlatma.",
		},
		{
			title: "Mağaza Raf Sistemleri",
			desc: "Yeni açılacak butik mağazanın tüm raf sistemlerinin kurulumu.",
		},
		{
			title: "Toplantı Odası Akustik Panel",
			desc: "Ses yalıtımı için duvar panellerinin montajı.",
		},
		{
			title: "Mutfak Dolabı Montajı - Villa X",
			desc: "Üst segment mutfak dolabı ve ankastre set kurulumu.",
		},
		{
			title: "Okul Kütüphane Rafları",
			desc: "Metal raf sistemleri ve okuma masaları montajı.",
		},
		{
			title: "Restoran Dış Mekan Mobilya",
			desc: "Bahçe mobilyaları ve şemsiye sistemleri kurulumu.",
		},
		{
			title: "Lojistik Depo Raf Ünitesi",
			desc: "Ağır yük raf sistemleri kurulumu.",
		},
