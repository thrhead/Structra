			...
			<View style={styles.modalOverlay}>
				...
				>
					<Text style={[styles.modalTitle, { color: textMain }]}>
						{initialData ? "Kullanıcıyı Düzenle" : "Yeni Kullanıcı"}
					</Text>
					...
					>
						...
						<CustomInput
							label={
								initialData ? "Şifre (Değiştirmek için doldurun)" : "Şifre *"
							}
						...
						{initialData && (
							<View style={styles.switchContainer}>
								<Text style={[styles.label, { color: textMain, marginTop: 0 }]}>
									Hesap Durumu
								</Text>
						...
						<View style={styles.roleSelector}>
							{["WORKER", "TEAM_LEAD", "MANAGER", "ADMIN", "CUSTOMER"].map(
								(role) => (
									<TouchableOpacity
										key={role}
										style={[
