				...
				steps.map((step, index) => (
					...
					>
						<View style={styles.stepHeader}>
							<Text style={[styles.stepIndex, { color: colors.subText }]}>
								{index + 1}.
							</Text>
							<View style={{ flex: 1 }}>
								<CustomInput
								...
								<CustomInput
									...
									onChangeText={(text) =>
										onUpdateStep(index, "description", text)
									}
							...
							<View style={styles.stepActions}>
								<TouchableOpacity
									...
									style={[
										styles.iconButton,
										index === 0 && styles.disabledIcon,
									]}
								>
									<MaterialIcons
										name="keyboard-arrow-up"
										size={20}
										color={colors.subText || COLORS.slate400}
									/>
								</TouchableOpacity>
								<TouchableOpacity
									...
									style={[
										styles.iconButton,
										index === steps.length - 1 && styles.disabledIcon,
									]}
								>
									<MaterialIcons
								...
								>
									<MaterialIcons
										name="close"
										size={20}
										color={colors.error || COLORS.red500}
									/>
								</TouchableOpacity>
							</View>
						</View>
						...
						<View
							style={[
								styles.subStepsContainer,
								{ borderLeftColor: colors.border },
							]}
						>
							{step.subSteps?.map((subStep, subIndex) => (
								<View
									key={subStep.id || subStep.tempId || subIndex}
								...
								>
									...
									<View style={{ flex: 1, marginLeft: 8 }}>
										<CustomInput
											value={subStep.title}
											onChangeText={(text) =>
												onUpdateSubStep(index, subIndex, text)
											}
							...
							>
								<MaterialIcons
									name="add"
									size={16}
									color={colors.primary || COLORS.blue500}
								/>
								<Text
									style={[
										styles.addSubStepText,
										{ color: colors.primary || COLORS.blue500 },
									]}
								>
									Alt Görev Ekle
