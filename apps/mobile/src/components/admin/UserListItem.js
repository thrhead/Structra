		...
		>
			<View
				style={[
					styles.userIcon,
					{
						backgroundColor: theme ? theme.colors.background : COLORS.slate800,
						borderColor: borderColor,
					},
				]}
			>
				<Text style={[styles.userIconText, { color: primary }]}>
			...
			<View style={styles.userInfo}>
				...
				<View
					style={[styles.roleContainer, { backgroundColor: `${primary}15` }]}
				>
			...
			<View style={styles.actionButtons}>
				...
				>
					<MaterialIcons
						name="delete"
						size={20}
						color={theme ? theme.colors.error : COLORS.red500}
					/>
				</TouchableOpacity>
			</View>
		</View>
