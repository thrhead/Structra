...
const JobGridItem = ({ job, onPress, style }) => {
	...
	const contactPerson =
		job.customer?.user?.name || job.contactPerson || "Yetkili Yok";
		...
		>
			...
			<View style={styles.content}>
				...
				<View style={styles.detailItem}>
					...
					<Text
						style={[styles.subDetailText, { color: theme.colors.subText }]}
						numberOfLines={1}
					>
						{contactPerson}
					</Text>
					...
					<View
						style={[
							styles.progressFill,
							{
								...
								backgroundColor:
									job.status === "COMPLETED" ? "#22c55e" : theme.colors.primary,
							},
						]}
					/>
				</View>
