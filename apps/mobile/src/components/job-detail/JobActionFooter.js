...
const JobActionFooter = ({
	...
	const _isAdminOrManager = ["ADMIN", "MANAGER"].includes(
		...
		>
			{isWorker ? (
				...
				<View style={{ width: "100%" }}>
					<View
						style={[
							styles.acceptanceStatusContainer,
							{
