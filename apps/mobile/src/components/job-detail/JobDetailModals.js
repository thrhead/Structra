	...
	return (
		<>
			...
			>
				<View style={[styles.modalOverlay, { backgroundColor: "black" }]}>
					...
					{selectedImage && (
						<Image
							source={{
								uri: getValidImageUrl(selectedImage.url || selectedImage),
							}}
						...
						>
							<Text style={[styles.modalTitle, { color: theme.colors.text }]}>
								{rejectionType === "JOB"
									...
									: rejectionType === "STEP"
										? t("alerts.rejectStep")
										: t("alerts.rejectSubstep")}
							</Text>

							<Text
								style={[styles.inputLabel, { color: theme.colors.subText }]}
							>
			...
			>
				<View style={styles.modalOverlay}>
					...
					>
						...
						<Text
							style={[styles.modalSubtitle, { color: theme.colors.subText }]}
						>
						...
						<View style={{ gap: 12 }}>
							...
							>
								<Text style={styles.submitButtonText}>
									{t("alerts.finishWithoutSignature")}
								</Text>
							</TouchableOpacity>
							<TouchableOpacity
								style={[
			...
			<CreateExpenseModal
				...
				onSubmit={(formData, receiptImage, audioUri, _id) => {
