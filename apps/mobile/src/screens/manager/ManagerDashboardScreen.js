			...
			>
				...
				<View style={styles.statsContainer}>
					...
					>
						<GlassCard
							theme={theme}
							style={{ flex: 1, margin: 6, padding: 16 }}
						>
							<View
								style={{
									flexDirection: "row",
					...
					<GlassCard theme={theme} style={{ flex: 1, margin: 6, padding: 16 }}>
						...
						>
							<View>
								...
								>
									{statsData.completedJobsThisMonth}
								</Text>
							</View>
							...
							<View
								style={[
									styles.progressFill,
									{
										...
										width: `${statsData.efficiencyScore || 0}%`,
									},
								]}
							/>
						</View>
				...
				<View style={styles.section}>
					...
					{statsData.recentJobs?.length > 0 ? (
						...
						>
							<Text
								style={{ color: theme.colors.subText, fontStyle: "italic" }}
							>
								Henüz faaliyet bulunamadı.
							</Text>
						</GlassCard>
					)}
				</View>
				...
				<View style={styles.section}>
					...
					<View style={[styles.quickActions, { marginTop: 12 }]}>
						...
						<GlassCard
							theme={theme}
							style={{ flex: 1, padding: 16, alignItems: "center", gap: 12 }}
							onPress={() => navigation.navigate("AdvancedPlanning")}
						>
							<MaterialIcons
								name="trending-up"
								size={32}
					...
					<View style={[styles.quickActions, { marginTop: 12 }]}>
						...
						<GlassCard
							...
							style={{ flex: 1, padding: 16, alignItems: "center", gap: 12 }}
							onPress={() =>
								navigation.navigate("CustomerManagement", { openCreate: true })
							}
						>
