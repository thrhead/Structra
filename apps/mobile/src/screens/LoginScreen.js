				...
				>
					...
					<View style={styles.decorationContainer}>
						...
						<View
							style={[
								styles.circleOutline,
								{ width: 200, height: 200, borderRadius: 100, opacity: 0.2 },
							]}
						/>
						{/* Small Inner Circle */}
						<View
				...
				<View style={styles.buttonSection}>
					...
					<View style={styles.footerFeatures}>
						<View style={styles.featureItem}>
							...
							/>
							<Text
								style={[styles.featureText, { color: theme.colors.subText }]}
							>
								{t("auth.secure").toUpperCase()}
							</Text>
						</View>
						<View
