import { Award, Mail, ShieldCheck, Target, User } from "lucide-react-native";
...
const TeamDetailScreen = ({ route, navigation }) => {
	...
	const renderHeader = () => (
		<View style={styles.header}>
			<View
				style={[styles.scoreCard, { backgroundColor: theme.colors.primary }]}
			>
				...
				<View>
					...
					>
						{t("manager.performanceScore")}
					</Text>
					<Text
						style={[styles.scoreValue, { color: isDark ? "#000" : "#FFF" }]}
					>
						%{team?.performanceScore || 0}
					</Text>
				</View>
			</View>
			...
			<View style={styles.statsContainer}>
				...
				>
					...
					<Text style={[styles.statLabel, { color: theme.colors.subText }]}>
						{t("manager.completedJobs")}
					</Text>
					<Text style={[styles.statValue, { color: theme.colors.text }]}>
						{team?.stats?.completedJobs || 0}
					</Text>
				</View>
			</View>
			...
			<View style={styles.memberInfo}>
				...
				<View style={{ flex: 1 }}>
					...
					<View style={styles.emailRow}>
						...
						<Text
							style={[styles.memberEmail, { color: theme.colors.subText }]}
							numberOfLines={1}
						>
							{item.user.email}
						</Text>
