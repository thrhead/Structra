...
export default function AdminDashboardScreen({ navigation }) {
	...
	const navItems = [
		...
		{
			id: "planning",
			title: t("navigation.planning") || "Planning",
			icon: TrendingUp,
			route: "AdvancedPlanning",
			color: theme.colors.primary,
		},
		{
			id: "reports",
							...
							<View style={styles.mainContent}>
									...
									>
										{chartData.length > 0 ? (
											...
											>
												...
												/>
												<Text
													style={{ color: theme.colors.subText, fontSize: 14 }}
												>
													{t("common.noData") || "Veri bulunmuyor"}
												</Text>
											</View>
										)}
									</View>
										...
										>
											<View
												style={{
													padding: 12,
													borderRadius: 12,
													backgroundColor: theme.colors.cyanBg,
												}}
											>
								...
								<View style={[styles.section, { paddingBottom: 0 }]}>
									...
									>
										...
										>
											{t("admin.recentJobs") || "Recent Jobs"}
										</Text>
										<TouchableOpacity
