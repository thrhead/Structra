				...
				create: [
					{
						...
						subSteps: {
							create: [
								{
									title: "Temel terazisinin (kot farkı) kontrol edilmesi",
									order: 1,
								},
								{
									title:
										"Montaj alanının temizlenmesi ve güvenliğin sağlanması",
									order: 2,
								},
								{
									title: "Aksların işaretlenmesi ve merkezlemenin yapılması",
									order: 3,
								},
							],
						},
					},
					{
						...
						subSteps: {
							create: [
								...
								{
									title:
										"Yatay ve dikey birleşim yerlerine sızdırmazlık şeritlerinin çekilmesi",
									order: 2,
								},
								{
									title: "Panellerin birleştirilmesi ve geçici sabitleme",
									order: 3,
								},
								{
									title:
										"Tüm civata ve somunların tork değerine uygun sıkılması",
									order: 4,
								},
							],
						},
					},
					{
						...
						subSteps: {
							create: [
								{
									title: "Çatı konstrüksiyonunun (kirişlerin) montajı",
									order: 1,
								},
								{
									title: "Çatı panellerinin yerleştirilmesi ve vidalanması",
									order: 2,
								},
								{
									title: "Tepe kapağı ve havalandırma bacalarının montajı",
									order: 3,
								},
					...
					},
					{
						...
						subSteps: {
							create: [
								{
									title: "Silo ankrajlarının (temel bağlantılarının) yapılması",
									order: 1,
								},
				...
				create: [
					...
					},
					{
						...
						subSteps: {
							create: [
								{
									title: "En üst ring (2. Ring) panellerinin montajı",
									order: 1,
								},
								{
									title: "Çatı konstrüksiyonu ve panellerinin montajı",
									order: 2,
								},
					...
					},
					{
						...
						subSteps: {
							create: [
								{
									title: "Montajı biten üst kısmın krikolarla kaldırılması",
									order: 1,
								},
								{
									title: "Alt ring (1. Ring) panellerinin yerleştirilmesi",
									order: 2,
								},
								{
									title: "Kat arası sızdırmazlık contalarının uygulanması",
									order: 3,
								},
								{
									title: "Üst ve alt ringin birleşim civatalarının sıkılması",
									order: 4,
								},
								{
									title: "Silonun krikolardan indirilerek zemine oturtulması",
									order: 5,
								},
							],
						},
					},
					{
						...
						subSteps: {
							create: [
								{
									title: "Dış merdiven ve güvenlik kafesinin montajı",
									order: 1,
								},
					...
					},
					{
						...
						subSteps: {
							create: [
								...
								{
									title: "Mastic (silikon) uygulamalarının kontrolü",
									order: 3,
								},
