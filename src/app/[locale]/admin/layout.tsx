		...
		<SidebarProvider>
			...
			<SidebarInset>
						...
						<Breadcrumb>
							<BreadcrumbList>
								<BreadcrumbItem className="hidden md:block">
									<BreadcrumbLink
										href="/admin"
										className="text-[10px] font-bold uppercase tracking-[0.18em] text-slate-400 dark:text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 transition-colors"
									>
										Saha Operasyon
									</BreadcrumbLink>
								</BreadcrumbItem>
				...
				<div className="flex flex-1 flex-col gap-4 p-4 md:p-6 lg:p-8 pt-6">
					<main className="w-full h-full animate-page-enter">{children}</main>
				</div>
			</SidebarInset>
		</SidebarProvider>
	);
