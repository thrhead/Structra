...
import { ArrowLeft, Mail, Phone, MapPin, Building2, Briefcase, BarChart3 } from "lucide-react"
        ...
        <div className="space-y-6">
            ...
            <Tabs defaultValue="overview" className="w-full space-y-6">
                ...
                <TabsContent value="reports">
                    <CustomerDetailedReport stats={reportData.stats} />
                </TabsContent>
            </Tabs>
        </div>
    )
