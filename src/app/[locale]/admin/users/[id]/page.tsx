					...
					<CardContent className="pt-6">
						<div className="flex items-center gap-4">
							...
							<div>
								...
								<p className="text-2xl font-bold">
									{reports.kpis.completedProjectCount}
								</p>
							</div>
						</div>
					</CardContent>
					...
					<CardContent className="pt-6">
						<div className="flex items-center gap-4">
							...
							<div>
								...
								<p className="text-2xl font-bold">
									{reports.kpis.activeProjectCount}
								</p>
							</div>
						</div>
					</CardContent>
					...
					<CardContent className="pt-6">
						<div className="flex items-center gap-4">
							...
							<div>
								...
								<p className="text-2xl font-bold">
									{reports.kpis.totalExpenditure.toLocaleString("tr-TR")} ₺
								</p>
							</div>
						</div>
					</CardContent>
											...
											>
												<div>
													...
													<p className="text-xs text-gray-500">
														Katılım:{" "}
														{format(new Date(tm.joinedAt), "d MMM yyyy", {
															locale: tr,
														})}
													</p>
												</div>
								...
								{user.managedTeams.length > 0 && (
									<div className="mt-4 pt-4 border-t">
										...
										{user.managedTeams.map((team: any) => (
											<div
												key={team.id}
												className="p-2 bg-blue-50 text-blue-700 rounded mb-2"
											>
												{team.name}
											</div>
										))}
