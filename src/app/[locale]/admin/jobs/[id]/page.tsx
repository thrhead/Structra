...
export default async function AdminJobDetailsPage(props: {
		...
		return (
			<div className="p-8 text-center">
				...
				<p className="text-gray-500 mt-2">
					Aradığınız iş mevcut değil veya silinmiş.
				</p>
				<Link
					href="/admin/jobs"
	...
	const pendingApproval = rawPendingApproval
		? JSON.parse(JSON.stringify(rawPendingApproval))
		: null;
					...
					<div>
						<div className="flex items-center gap-2">
							...
							<div className="flex items-center gap-2">
								<Badge
									variant="outline"
									className="text-lg py-0 h-8 font-mono bg-orange-50 text-orange-700 border-orange-200"
								>
									{job.jobNo || "NO-CODE"}
								</Badge>
								<Badge
									variant="outline"
									className="text-sm py-0 h-8 font-mono bg-blue-50 text-blue-700 border-blue-200"
								>
