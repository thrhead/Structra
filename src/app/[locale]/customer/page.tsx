...
export default async function CustomerDashboard(props: {
	...
	const { jobs, stats, statusDistribution, recentUpdates } =
		await getCustomerDashboardData(session?.user?.id || "");
			...
			<div className="grid gap-8 lg:grid-cols-3">
										...
										>
											<div>
												<div className="flex items-start justify-between gap-2 mb-3">
													...
													<Badge
														variant="secondary"
														className="shrink-0 bg-blue-50 text-blue-700 hover:bg-blue-100 border-none"
													>
														{job.status}
													</Badge>
												</div>
				...
				<div className="space-y-8">
					...
					<div className="bg-gradient-to-br from-indigo-600 to-purple-700 p-6 rounded-3xl text-white shadow-lg lg:hidden">
						<h3 className="text-sm font-medium opacity-80 uppercase tracking-wider mb-2">
							Başarı Oranı
						</h3>
						<div className="flex items-baseline gap-2">
										...
										>
											...
											<div className="min-w-0">
												...
												<p className="text-[10px] text-gray-400 mt-1 flex items-center gap-1">
													...
													{formatDistanceToNow(new Date(update.completedAt), {
														addSuffix: true,
					...
					<div className="bg-blue-50 border border-blue-100 p-6 rounded-3xl">
						...
						<p className="text-sm text-blue-700/80 mb-4">
							İşlerinizle ilgili detaylı bilgi almak veya revize talepleriniz
							için müşteri temsilcinizle iletişime geçebilirsiniz.
						</p>
