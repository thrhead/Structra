										...
										>
											...
											<div className="flex-1 min-w-0">
												...
												<p className="text-xs text-gray-500 mt-0.5">
													{job.customer.company} • {job.creator.name}
												</p>
						...
						<div className="grid gap-4 sm:grid-cols-2">
							{pendingApprovals.length > 0 ? (
								pendingApprovals.map((approval) => (
									<div
										key={approval.id}
										className="bg-white border border-gray-200 p-4 rounded-xl shadow-sm hover:border-blue-300 transition-colors"
									>
										<div className="flex items-start gap-3">
											...
											<div className="flex-1 min-w-0">
												...
												<div className="mt-2 flex items-center justify-between">
													...
													<Link
														href={`/manager/jobs/${approval.jobId}`}
				...
				<div className="space-y-8">
					...
					<Card className="border-none shadow-sm bg-blue-50">
						...
						<CardContent className="space-y-3">
							<Link
								href="/manager/jobs"
								className="flex items-center gap-3 p-3 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow group"
							>
								<div className="flex items-center gap-3">
									...
									<div>
										<h3 className="font-semibold text-blue-900 text-sm">
											{t("quickActions.newJob.title")}
										</h3>
										<p className="text-[10px] text-blue-600/70">
											{t("quickActions.newJob.desc")}
										</p>
									</div>
								</div>
							</Link>
							...
							>
								<div className="flex items-center gap-3">
									...
									<div>
										<h3 className="font-semibold text-blue-900 text-sm">
											{t("quickActions.reports.title")}
										</h3>
										<p className="text-[10px] text-blue-600/70">
											{t("quickActions.reports.desc")}
										</p>
									</div>
								</div>
							</Link>
					...
					<div>
						...
						<div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
							...
							<Link
								href="/manager/logs"
								className="block w-full p-3 text-center text-[10px] font-bold text-blue-600 hover:bg-gray-50 border-t border-gray-100 uppercase tracking-widest"
							>
