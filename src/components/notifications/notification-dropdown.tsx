...
export function NotificationDropdown() {
	...
	return (
		<Popover open={open} onOpenChange={setOpen}>
			...
			<PopoverContent
				align="end"
				className="w-80 p-0 overflow-hidden shadow-2xl rounded-2xl border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950"
			>
						...
						{notifications.map((notification) => (
							...
							>
								...
								<div className="flex-1 min-w-0">
									<p
										className={`text-sm ${!notification.isRead ? "font-semibold text-slate-900 dark:text-slate-100" : "font-medium text-slate-700 dark:text-slate-300"}`}
									>
										{notification.title}
									</p>
