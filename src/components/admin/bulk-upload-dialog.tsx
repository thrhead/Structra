	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			<DialogTrigger asChild>
				<Button
					variant="outline"
					className="gap-2 rounded-xl h-10 px-4 border-slate-200 hover:bg-emerald-50 hover:text-emerald-600 transition-all duration-200"
				>
					...
					<div className="bg-emerald-50/50 dark:bg-emerald-950/20 p-5 rounded-2xl border border-emerald-100/50 dark:border-emerald-900/30 flex items-start gap-3 shadow-sm">
						...
						<div className="text-sm text-emerald-800 dark:text-emerald-300 space-y-2">
							...
							<ul className="list-decimal pl-4 space-y-1 opacity-90">
								...
								<li>
									Aynı &quot;Job Title&quot;a sahip satırlar tek bir iş olarak
									gruplanır.
								</li>
						...
						>
							...
							{result.count !== undefined && (
								<p className="text-sm font-semibold mb-2 opacity-90">
									{result.count} iş başarıyla oluşturuldu.
								</p>
							)}
							{result.errors && result.errors.length > 0 && (
