					...
					<FieldGroup>
								...
								<div className="grid grid-cols-2 gap-4">
									<Field>
										...
										<Input
											...
											type="email"
											{...register("email")}
											placeholder="ahmet@structra.com"
											required
										/>
										{errors.email && (
											<FieldDescription className="text-destructive font-medium">
							...
							<FieldGroup>
								...
								{isEditing && (
									<Field
										...
										className="flex items-center justify-between rounded-2xl border border-slate-200 dark:border-slate-800 p-4 bg-slate-50/50 dark:bg-slate-900/50"
									>
										<div className="flex flex-col gap-0.5">
											...
											<FieldDescription>
												{currentStatus
													? "Kullanıcı sistemde aktif"
													: "Kullanıcı girişi engellenmiş"}
											</FieldDescription>
										</div>
										<Switch
						...
						<div className="flex justify-end gap-3 mt-6 pt-2">
							...
							<Button
								type="submit"
								disabled={isLoading}
								className="rounded-xl bg-slate-900 dark:bg-slate-50 text-white dark:text-slate-900 px-8"
							>
								{isLoading ? (
									<>
