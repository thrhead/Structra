...
const AdminJobDetailsTabs = dynamic(
	() =>
		import("@/components/admin/job-details-tabs").then(
			(mod) => mod.AdminJobDetailsTabs,
		),
	{
		ssr: false,
		loading: () => (
...
export function JobDetailsClientWrapper({
	pendingApproval,
	...props
}: JobDetailsClientWrapperProps) {
	return (
		<div className="space-y-6">
			{pendingApproval && <ApprovalActionCard approval={pendingApproval} />}
