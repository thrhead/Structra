        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-4">
          <FieldGroup>
            ...
            <Field>
              ...
              <div className="border rounded-xl p-3 space-y-2 max-h-[250px] overflow-y-auto bg-gray-50/50">
                      ...
                      <div key={user.id} className="flex items-center justify-between space-x-2 py-1">
                        <div className="flex items-center space-x-2 flex-1">
                          ...
                          >
                            {user.name}
                            {user.role === 'TEAM_LEAD' && (
                              <span className="ml-2 text-xs text-indigo-600 font-bold uppercase">(Lider)</span>
                            )}
                          </label>
                        </div>
                      </div>
              ...
              <p className="text-[10px] text-gray-400 font-medium tracking-tight">
                * Listeden ekip üyelerini seçerek görevlendirme yapabilirsiniz.
              </p>
            </Field>
