...
export default function WorkloadCostChart({
	data,
	title = "İş Yoğunluğu ve Maliyetler",
}: WorkloadCostChartProps) {
	...
	return (
		<Card className="col-span-1 shadow-sm border-slate-200 dark:border-slate-800">
			<CardHeader>
				...
				<CardDescription>
					Günlük maliyet ve yaklaşık iş yoğunluğu endeksi
				</CardDescription>
			</CardHeader>
			<CardContent>
						...
						<ComposedChart data={chartData}>
							...
							<Tooltip
								formatter={(value: any, name: string) => {
									if (name === "maliyet")
										return [formatCurrency(Number(value) || 0), "Maliyet"];
