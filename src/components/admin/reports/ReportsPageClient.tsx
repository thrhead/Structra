		...
		<div className="space-y-6">
			<div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
				<div className="flex items-center gap-4">
					...
					<div>
						...
						<h1 className="text-2xl font-bold tracking-tight text-slate-800 dark:text-slate-100 mt-0.5">
							Raporlar ve Analiz
						</h1>
						<p className="text-sm text-slate-400 dark:text-slate-500 mt-0.5">
							Tüm performans, maliyet ve ekip verileri tek panelde.
						</p>
					</div>
				</div>
			...
			>
				<TabsList className="bg-slate-100 dark:bg-slate-800/60 p-1 rounded-2xl h-auto gap-1">
					<TabsTrigger
						value="modern"
						className="gap-2 rounded-xl text-xs px-4 py-2"
					>
						<LayoutDashboard className="w-3.5 h-3.5" /> Genel Bakış
					</TabsTrigger>
					<TabsTrigger
						value="strategic"
						className="gap-2 rounded-xl text-xs px-4 py-2"
					>
						<BarChart3 className="w-3.5 h-3.5" /> Stratejik
					</TabsTrigger>
					<TabsTrigger
						value="tactical"
						className="gap-2 rounded-xl text-xs px-4 py-2"
					>
						<TrendingUp className="w-3.5 h-3.5" /> Taktiksel
					</TabsTrigger>
					<TabsTrigger
						value="operational"
						className="gap-2 rounded-xl text-xs px-4 py-2"
					>
						<Zap className="w-3.5 h-3.5" /> Operasyonel
					</TabsTrigger>
				</TabsList>
