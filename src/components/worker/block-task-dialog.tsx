				...
				<div className="flex flex-col items-center text-center mb-2">
					...
					<DialogHeader className="text-center sm:text-center space-y-3">
						...
						<DialogDescription className="text-base text-slate-500 dark:text-slate-400 leading-relaxed max-w-[340px] mx-auto">
							&quot;{taskTitle}&quot; {isSubStep ? "alt görevini" : "görevini"}{" "}
							tamamlayamama nedeninizi belirtin.
						</DialogDescription>
					</DialogHeader>
				</div>
				...
				<div className="space-y-6 py-4">
					<div className="space-y-2">
						...
						<Select value={reason} onValueChange={setReason}>
							<SelectTrigger
								id="reason"
								className="rounded-xl h-12 border-slate-200 focus:ring-amber-500/20 shadow-xs"
							>
