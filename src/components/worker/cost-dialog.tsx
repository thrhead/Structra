...
import { CameraIcon, Wallet } from "lucide-react";
					...
					<div className="space-y-3">
						...
						{receiptUrl && (
							<div className="mt-2 relative h-40 w-full rounded-2xl overflow-hidden border border-emerald-100 shadow-md animate-in fade-in zoom-in duration-300">
								...
								/>
								<div
									className="absolute inset-0 bg-black/10 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity cursor-pointer"
									onClick={handlePhotoUpload}
								>
									<span className="bg-white/90 px-3 py-1.5 rounded-full text-xs font-bold text-slate-700 shadow-lg">
										Değiştir
									</span>
								</div>
							</div>
