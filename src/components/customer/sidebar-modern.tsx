...
import { BriefcaseIcon, LayoutIcon, LogOutIcon, UserIcon } from "lucide-react";
	...
	return (
		...
		>
			<SidebarHeader className="h-16 border-b border-sidebar-border flex items-center px-4">
				<Link
					href="/customer"
					className="flex items-center gap-2 group-data-[collapsible=icon]:justify-center w-full"
				>
